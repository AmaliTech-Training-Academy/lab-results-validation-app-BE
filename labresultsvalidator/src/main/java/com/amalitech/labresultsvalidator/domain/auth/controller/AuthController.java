...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<LoginResponse>> changePassword(
        ...
        LoginResponse loginResponse = authService.changePassword(authentication.getName(), request);
        cookieUtils.setRefreshTokenCookie(response, loginResponse.getRefreshToken());

        return ResponseEntity.ok(ApiResponse.success("Password changed successfully", loginResponse));
    }
}
